                ...
                <div class="col-12">
                  <div class="table-responsive">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <?php
                      $count=1;
                      $result=mysqli_query($conn,"select f.*,s.subcat_name,x.policestation_name,p.pname from tbl_fir as f left join tbl_subcategory as s on f.subcat_id=s.subcat_id left join tbl_policestation as x on f.policestation_id=x.policestation_id left join tbl_policestation_subuser as p on f.p_userid=p.p_userid") or die(mysqli_error($conn));
