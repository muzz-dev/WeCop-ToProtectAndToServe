                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="AddFIRLog" method="post">
                   ...
                   if(isset($_POST["btnsubmit"]))
                   {
                     ...
                     if($result==true)
                      {
                        $res=mysqli_query($conn,"select f.*,u.uname,u.token from tbl_fir as f left join tbl_user as u on f.userid =u.userid");
                          while($row=mysqli_fetch_assoc($res))
                          {
                            sendnotification("Some updates on your FIR!",$_POST["uname"],$row["token"]);
                          }
                          ?>
                        ?>
                    ...
                    <div class="form-group">
                      <label for="exampleSelectGender">FIR</label>
                        <select class="form-control" id="" name="txtfirid">
                          ...
                          {
                          ?>
                          <option value="<?php echo $row["fir_id"]; ?>"><?php echo $row["title"]; ?></option>
                          <?php
                          }
                          ?>
                        </select>
