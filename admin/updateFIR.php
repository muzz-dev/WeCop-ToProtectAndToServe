            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" id="UpdateFIR" enctype="multipart/form-data" method="post">
                    <?php
                      if(isset($_POST["btnsubmit"]))
                      {
                        ...
                        #firtype,lat,long,act

                        $id=my_simple_crypt($_GET["updateid"],'d');
                        $str="update tbl_fir set subcat_id='".$_POST["txtsubcatid"]."',cname='".$_POST["txtname"]."',contact='".$_POST["txtcontact"]."',email='".$_POST["txtemailid"]."',title='".$_POST["txttitle"]."',description='".$_POST["txtdescription"]."',scrimedate='".$startdate."',scrimetime='".$starttime."',ecrimedate='".$enddate."',ecrimetime='".$endtime."',firdate='".$firdate."',firtime='".$firtime."',address='".$_POST["txtaddress"]."',landmark='".$_POST["txtlandmark"]."',pincode=".$_POST["txtpincode"].",policestation_id=".$_POST["txtpolicestationid"].",fir_type='".$_POST["txtfirtype"]."',latitude='".$_POST["txtlatitude"]."',longtitude='".$_POST["txtlongitude"]."',act='".$_POST["txtact"]."',imageurl1='".$newname1."',imageurl2='".$newname2."' where fir_id='".$id."'";
                      ...
                      if(isset($_GET["updateid"]))
                      {
                        ...
                        $result=mysqli_query($conn,"select *,x.cat_id,a.act_id from tbl_state as s left join tbl_city as c on c.state_id=s.state_id left join tbl_zone as z on z.city_id=c.city_id left join tbl_policestation as p on p.zone_id=z.zone_id left join tbl_fir as f on f.policestation_id=p.policestation_id left join tbl_subcategory as x on x.subcat_id=f.subcat_id left join tbl_act as a on a.subcat_id=x.subcat_id where f.fir_id='".$id."'") or die(mysqli_error($conn));
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="txtzoneid" id="txtzoneid">
                              <?php
                              $result=mysqli_query($conn,"select * from tbl_zone where city_id='".$item["city_id"]."'") or die(mysqli_error($conn));
                          while($row=mysqli_fetch_assoc($result))
                          {
                        ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="txtpolicestationid" id="txtpolicestationid">
                              <?php
                              $result=mysqli_query($conn,"select * from tbl_policestation where zone_id='".$item["zone_id"]."'") or die(mysqli_error($conn));
                          while($row=mysqli_fetch_assoc($result))
                          {
                        ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="txtsubcatid" id="txtsubcatid">
                              ...
                              <?php
                                  $count=1;
                                  $result=mysqli_query($conn,"select * from tbl_subcategory where cat_id='".$item["cat_id"]."'") or die(mysqli_error($conn));
                                  while($row=mysqli_fetch_assoc($result))
                                  {
                                ?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea rows="7" cols="15" placeholder="Description"class="form-control" name="txtdescription"><?php echo $item["description"]; ?></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $item["landmark"]; ?>" placeholder="LandMark" class="form-control" id="txtlandmark" name="txtlandmark"/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $item["latitude"]; ?>" placeholder="Latitude" class="form-control" id="txtlatitude" name="txtlatitude"/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $item["longtitude"]; ?>" placeholder="Longitude" class="form-control" name="txtlongitude" id="txtlongitude"/>
                          </div>
                        </div>
                      </div>
