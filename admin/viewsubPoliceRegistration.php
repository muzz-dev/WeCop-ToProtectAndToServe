...
<head>
  ...
  <title>Sub Policestation Users - Admin</title>
  <!-- plugins:css -->
                  ...
                  <div class="table-responsive">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <?php
                          $count=1;
                          $result=mysqli_query($conn,"select s.*,p.policestation_name from tbl_policestation_subuser as s left join tbl_policestation as p on s.policestation_id=p.policestation_id") or die(mysqli_error($conn));
