...
<head>
  ...
  <title>Sub Police Registration- Admin</title>
  <!-- plugins:css -->
                ...
                <div class="card-body">
                  ...
                  <?php
                    if (isset($_POST["btnsubmit"])) {
                      ...
                      $result=mysqli_query($conn,"insert into tbl_policestation_subuser(policestation_id,pname,contact,email,profilephoto,gender,username,password,isblock) values(".$_POST['txtpolicestationid'].",'".$_POST['txtpolicename']."','".$_POST['txtcontact']."','".$_POST['txtemail']."','".$newname."','".$_POST['gender']."','".$_POST['txtusername']."','".$_POST['txtpassword']."','".$_POST['isblock']."')") or die(mysqli_error($conn));
