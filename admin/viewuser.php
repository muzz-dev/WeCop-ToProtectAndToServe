              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    ...
                    {
                      $id=$_POST["deleteid"];
                      $result=mysqli_query($conn,"update tbl_user set isblock='Y' where userid='".$id."'");
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                               <button type="button" onclick="showpopup(<?php echo $row["userid"]; ?>);" class="btn btn-lg btn-outline-danger">BLOCK</button>
                               <?php
                               if($row["isblock"]=='Y')
                               {
                                ?>
                                <button type="button" onclick="showpopup(<?php echo $row["userid"]; ?>);" class="btn btn-lg btn-outline-success">UNBLOCK</button>
                                <?php
                               }
                               ?>
  ...
  <script>
   ...
   <!-- <script>
        function showpopup(spid)
        {
          ...
          swal({
              title: 'Are you sure to Unblock User?',
              text: "You won't be able to revert this!",
              icon: 'warning',
              showCancelButton: true,
              confirmButtonColor: '#3f51b5',
