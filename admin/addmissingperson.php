...
<head>
  ...
  <title>Add Missing Person - Admin</title>
  <!-- plugins:css -->
...
sendnotification("New Missing Person Added!","test","c4rGd903RPeyTikIlFqqCc:APA91bEnnYEFhYf-6e1cDFs9ZeApOCo7ORd2c7zn1xz8jIeS-nFgCRlYJgpgILVu1odwi7F8SeFCaUb0_y_GBHMTM_0MkR0NHQUH_MnsTjKpcd4T3ylC0NQEO4P3a09OAxuZSVKrBZqB",'contact','20');
                  ...
                  <form class="form-sample" id="AddMissingPerson" enctype="multipart/form-data" method="post">
                    <?php
                      if(isset($_POST["btnsubmit"]))
                      {
                        ...
                        $result=mysqli_query($conn,"insert into tbl_missing_person(mname,mphoto,gender,age,lastaddress1,lastaddress2,landmark,lattitude,longtitude,pincode,lastlocationtype,contactname,contactmobilenumber,isdisplay,missingdate,missingtime,moredetails,city_id) values('".$_POST["txtmname"]."','".$newname1."','".$_POST["gender"]."','".$_POST["txtage"]."','".$_POST["txtaddress1"]."','".$_POST["txtaddress2"]."','".$_POST["txtlandmark"]."','".$_POST["txtlatitude"]."','".$_POST["txtlongitude"]."','".$_POST["txtpincode"]."','".$_POST["txtlastlocationtype"]."','".$_POST["txtcname"]."','".$_POST["txtcnumber"]."','".$_POST["isdisplay"]."','".$missingdate."','".$missingtime."','".$_POST["txtmoredetail"]."',".$_POST["txtcityid"].")") or die(mysqli_error($conn)) or die(mysqli_query($conn));

                        $insertid=mysqli_insert_id($conn);

                        $result1=mysqli_query($conn,"insert into tbl_notification(notification_title,notification_desc,notification_page,notification_pageid) values('New Missing Person Added !!!','".$_POST["txtmname"]."','MissingPerson','".$insertid."')")or die (mysqli_error($conn));
                        ...
                        if($result==true)
                        {
                          ...
                          {
                            // echo $row["token"];
                            #Deep Kansara has been missing from Surat
                            #Last Seen on 18/05/2021
                            sendnotification("New Missing Person Added!",$_POST["txtmname"],$row["token"],'missing','10');
                          }
                          ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea cols="15" rows="7" placeholder="More Detail"class="form-control" name="txtmoredetail"/></textarea>
                          </div>
                        </div>
                      </div>
