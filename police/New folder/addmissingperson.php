                  ...
                  <form class="form-sample" id="AddMissingPerson" enctype="multipart/form-data" method="post">
                    <?php
                      if(isset($_POST["btnsubmit"]))
                      {
                        ...
                        $result=mysqli_query($conn,"insert into tbl_missing_person(mname,mphoto,gender,age,lastaddress1,lastaddress2,landmark,pincode,lastlocationtype,latitude,longtitude,contactname,contactmobilenumber,isdisplay,moredetails,city_id) values('".$_POST["txtmname"]."','".$newname1."','".$_POST["gender"]."','".$_POST["txtage"]."','".$_POST["txtaddress1"]."','".$_POST["txtaddress2"]."','".$_POST["txtlandmark"]."','".$_POST["txtpincode"]."','".$_POST["txtlastlocationtype"]."','".$_POST["txtlatitude"]."','".$_POST["txtlongitude"]."','".$_POST["txtcname"]."','".$_POST["txtcnumber"]."','".$_POST["isdisplay"]."','".$_POST["txtmoredetail"]."',".$_POST["txtcity"].")") or die (mysqli_error($conn));
