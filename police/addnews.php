...
<head>
  ...
  <title>Add News - Police Station</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  if (isset($_POST['btnsubmit']))
                  {
                    ...
                    $result = mysqli_query($conn,"insert into tbl_news (title,newsdescription,newsimage,isactive) values('".$_POST['txttitle']."','".$_POST['txtnewsdicription']."','".$newname."','".$_POST["isactive"]."')")or die(mysqli_error($conn));
                  ...
                  <form class="forms-sample" method="post" id="AddNews" enctype="multipart/form-data">
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="" placeholder="News Description" name="txtnewsdicription">
                    </div>
                      ...
                      <div class="input-group ">
                        ...
                        <span class="input-group-append">
                          <button class="file-upload-browse btn btn-primary" name="newsphoto" type="button">Upload</button>
                        </span>
                      </div>
                    </div>
