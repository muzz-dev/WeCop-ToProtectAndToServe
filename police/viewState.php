...
<head>
  ...
  <title>State - Police Station</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <!-- <div class="col-sm">
                  <button type="submit" name="btnAddState" class="btn btn-primary mr-2 float-right" onclick="document.location.href='addState.php';">Add State</button>
                </div> -->
              </div>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td>
                              <button type="button" onclick="showpopup(<?php echo $row["state_id"]; ?>);" class="btn btn-social-icon btn-outline-youtube"><i class="mdi mdi-delete"></i></button>
                              <button type="button" class="btn btn-social-icon btn-outline-facebook" onclick="document.location.href='updatestate.php?updateid=<?php echo my_simple_crypt($row["state_id"],'e'); ?>';"><i class="mdi mdi-account-edit"></i></button>
                            </td> -->
                        </tr>
        ...
        <form method="post" action="viewState.php" id="form1">
