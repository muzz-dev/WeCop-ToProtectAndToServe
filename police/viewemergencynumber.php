...
<head>
  ...
  <title>Emergency Number - Police Station</title>
  <!-- plugins:css -->
          ...
          <div class="card">
            <div class="card-body">
             <div class="row">
              ...
              <!-- <div class="col-6">
                <button type="submit" name="btnstate" class="btn btn-primary mr-2 float-right" onclick="document.location.href='addemergencynumber.php'">Add Emergency Number</button>
              </div> -->
             </div>
