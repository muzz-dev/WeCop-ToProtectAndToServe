...
<head>
  ...
  <title>Acts - Police Station</title>
  <!-- plugins:css -->
                  ...
                  <div class="table-responsive">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <?php
                          $count=1;
                          $result=mysqli_query($conn,"select a.*,s.subcat_name from tbl_act as a left join tbl_subcategory as s on a.subcat_id=s.subcat_id") or die(mysqli_error($conn));
